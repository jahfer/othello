(defproject plaintext "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "plaintext.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main plaintext.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "plaintext.core/on-figwheel-reload"}

                :compiler {:main plaintext.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/plaintext.js"
